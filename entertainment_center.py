...
ADVENTURELAND = media.Movie("Adventureland",
                            "https://upload.wikimedia.org/wikipedia/en/thumb/b/bb/Adventurelandposter.jpg/215px-Adventurelandposter.jpg",
...
BIRDMAN = media.Movie("Birdman",
                      "https://upload.wikimedia.org/wikipedia/en/thumb/a/a3/Birdman_poster.jpg/220px-Birdman_poster.jpg",
...
BROKEN_FLOWERS = media.Movie("Broken Flowers",
                             "https://upload.wikimedia.org/wikipedia/en/thumb/7/79/Broken_Flowers_poster.jpg/220px-Broken_Flowers_poster.jpg",
...
DARJEELING_LIMITED = media.Movie("Darjeeling Limited",
                                 "https://upload.wikimedia.org/wikipedia/en/thumb/1/1e/Darjeeling_Limited_Poster.jpg/220px-Darjeeling_Limited_Poster.jpg",
...
EYES_WIDE_SHUT = media.Movie("Eyes Wide Shut",
                             "https://upload.wikimedia.org/wikipedia/en/thumb/c/c3/Ghostworldposter.jpg/215px-Ghostworldposter.jpg",
...
GHOST_WORLD = media.Movie("Ghost World",
                          "https://upload.wikimedia.org/wikipedia/en/thumb/8/87/Eyes_Wide_Shut_poster.jpg/220px-Eyes_Wide_Shut_poster.jpg",
                          "https://www.youtube.com/watch?v=YEfyfcEdW4Y",
                          "Terry Zwigoff",
...
HOLY_MOUNTAIN = media.Movie("Holy Mountain",
                            "https://upload.wikimedia.org/wikipedia/en/thumb/3/39/Holy_Mountain.gif/220px-Holy_Mountain.gif",
...
METROPOLIS = media.Movie("Metropolis",
                         "https://upload.wikimedia.org/wikipedia/en/thumb/0/06/Metropolisposter.jpg/220px-Metropolisposter.jpg",
...
MOONRISE_KINGDOM = media.Movie("Moonrise Kingdom",
                               "https://upload.wikimedia.org/wikipedia/en/thumb/4/4f/Moonrise_Kingdom_FilmPoster.jpeg/220px-Moonrise_Kingdom_FilmPoster.jpeg",
...
PULP_FICTION = media.Movie("Pulp Fiction",
                           "https://upload.wikimedia.org/wikipedia/en/thumb/8/82/Pulp_Fiction_cover.jpg/220px-Pulp_Fiction_cover.jpg",
...
SECRETARY = media.Movie("Secretary",
                        "https://upload.wikimedia.org/wikipedia/en/thumb/b/b9/Secretarymovpost.jpg/220px-Secretarymovpost.jpg",
...
SHAUN_OF_THE_DEAD = media.Movie("Shaun of the Dead",
                                "https://upload.wikimedia.org/wikipedia/en/thumb/e/ec/Shaun-of-the-dead.jpg/220px-Shaun-of-the-dead.jpg",
...
SHOPGIRL = media.Movie("Shopgirl",
                       "https://upload.wikimedia.org/wikipedia/en/thumb/5/57/Shopgirl.jpg/220px-Shopgirl.jpg",
...
TRUE_ROMANCE = media.Movie("True Romance",
                           "https://upload.wikimedia.org/wikipedia/en/thumb/d/d6/True_romance.jpg/215px-True_romance.jpg",
...
VIRGIN_SUICIDES = media.Movie("Virgin Suicides",
                              "https://upload.wikimedia.org/wikipedia/en/thumb/c/c9/Virgicides.jpg/220px-Virgicides.jpg",
                              "https://www.youtube.com/watch?v=n8LCLCUJYd8",
                              "Sofia Coppola",
                              "Kirsten Dunst, Josh Hartnett, James Woods",
                              "1999", False, None)

movies = [ADVENTURELAND, ALMOST_FAMOUS, AMERICAN_HUSTLE, AMERICAN_PSYCHO, BIG_LEBOWSKI,
          BIRDMAN, BROKEN_FLOWERS, DARJEELING_LIMITED, EDWARD_SCISSORHANDS, EYES_WIDE_SHUT,
          GHOST_WORLD, GOODFELLAS, GRAND_BUDAPEST_HOTEL, HOLY_MOUNTAIN, HOT_FUZZ, IDIOCRACY,
          IN_A_WORLD, LIFE_AQUATIC, LOST_IN_TRANSLATION, METROPOLIS, MOONRISE_KINGDOM,
          OFFICE_SPACE, PI, PULP_FICTION, ROYAL_TENENBAUMS, RUSHMORE, SECRETARY, SHAUN_OF_THE_DEAD,
          SOCIAL_NETWORK, TRUE_ROMANCE, VIRGIN_SUICIDES]
